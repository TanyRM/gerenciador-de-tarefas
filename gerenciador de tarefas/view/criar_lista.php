...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $titulo = $_POST['titulo']; // inserir o titulo
    $lista = new Lista($titulo);
    $usuario = $_SESSION['usuario']; 
    $usuario->adicionarLista($lista); // adiciona a lista ao array do usuario
...
<body>
    ...
    <a href="pagina_inicial.php">Voltar</a> <!-- redireciona para a pagina inicial -->
</body>
</html>

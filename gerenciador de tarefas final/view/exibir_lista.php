...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['novo_item']) && isset($_POST['titulo'])) {
        ...
        if ($listaExibir instanceof Lista) {
            ...
            $novoItem->setPrioridade($prioridade); // define a prioridade
    ...
    if ($listaExibir) { // se for instância de lista ?>
        ...
        <ul class='item-list'>
            ...
            foreach ($itens as $index => $item) {
                ...
                $itemPrioridade = $item->getPrioridade(); // obtem a prioridade
                ...
                if (isset($_GET['editar_item']) && $_GET['editar_item'] == $index) { // formulario se receber editar_item
                    ...
                    // Determina a classe de prioridade com base no número de prioridade
                    $prioridadeClass = "prioridade-" . $itemPrioridade;
            
                    // Exibe a prioridade com a classe de cor correspondente
                    echo " <span class='prioridade $prioridadeClass'>[$itemPrioridade]</span>"; // exibe a prioridade
        ...
        <form method="post">
            ...
            <!-- Campo para inserir a prioridade -->
